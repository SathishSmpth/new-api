package com.kamatchibotique.application.cms.product.gcp;
...
import com.kamatchibotique.application.cms.product.ProductAssetsManager;
...
public class GCPProductContentFileManager implements ProductAssetsManager {
  ...
  public GCPProductContentFileManager(CMSManager gcpAssetsManager) {
    this.gcpAssetsManager = gcpAssetsManager;
  }
